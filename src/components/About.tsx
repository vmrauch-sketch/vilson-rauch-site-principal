        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-12">
            ...
            <div className="space-y-6">
              ...
              <p className="text-lg text-gray-700 leading-relaxed">
                Sua visão inovadora e pró-cliente é sustentada por uma formação sólida. É mestre em Economia e Mercados pelo Mackenzie de São Paulo e especialista em Mercado Financeiro pela PUC Minas — duas formações que unem teoria econômica e aplicação prática. Esse repertório acadêmico reforça sua capacidade de interpretar cenários complexos e traduzi-los em estratégias patrimoniais e empresariais eficazes e sob medida.
              </p>
